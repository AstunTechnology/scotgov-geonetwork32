      ...
      return {
        ...
        link: function(scope, element, attrs, ctrls) {
          ...
          function init() {
            ...
            if (!source || !(source instanceof ol.source.ImageWMS || source instanceof ol.source.Vector ||
            ...
            try {
              ...
              scope.typename = attrs['typename'] ||
                  (scope.layer.getSource().getParams && scope.layer.getSource().getParams().LAYERS) || scope.layer.get('label');
              scope.formats = [];
              scope.checkWFSUrl();
            } catch (e) {
